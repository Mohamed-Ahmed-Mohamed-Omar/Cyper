...
namespace Cyper.Controllers
{
    ...
    public class ProblemController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateProblem([FromBody] UpdateProblem problem)
        {
            var username = User.FindFirstValue(ClaimTypes.NameIdentifier);
            ...
            problem.UserName = UserName; // Ensure UserName matches update target
        ...
        public async Task<IActionResult> DeleteProblem()
        {
            ...
            var data = await _problemRepository.DeleteAsync(user.UserName);
