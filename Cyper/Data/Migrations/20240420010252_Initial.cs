        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points_not_working = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Points_work = table.Column<int>(type: "int", nullable: false),
                    Nom_of_points = table.Column<int>(type: "int", nullable: false),
                    ...
                    Room_nom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Round = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_data_Collages", x => x.Id);
                });
